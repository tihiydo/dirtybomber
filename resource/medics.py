...
class Medics: 
    def __init__(self, number):
        self.setResourceName('Medics.ua')
        self.setRequestUrl('https://medics.ua/api/v1/verifications')
        ...
        self.setRequestData('')
        self.setRequestJson({"action_type":"registration","phone":str(number[1:]),"user":{"phone":str(number[1:])}})
